...
ACCENT = {
    ...
    # The Engine, generated by gen_engine_textures.py rather than here, but its ramp belongs in the
    # family's one palette. Hotter than any of the four above -- it is the only block in the mod
    # with a fire in it, and it should not be mistaken for the Centrifuge's amber at a distance.
    "engine": Ramp((0x5E, 0x18, 0x08), (0xB8, 0x38, 0x0E), (0xFF, 0x7A, 0x18), (0xFF, 0xD2, 0x7A)),
}
